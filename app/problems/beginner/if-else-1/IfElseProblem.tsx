      ...
      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle className="text-2xl">조건문 활용 #1</CardTitle>
...
`}</pre>
          ...
          <div className="mt-6">
            ...
            <p>
              위 코드는 점수를 바탕으로 학점을 계산합니다. 출력값을 입력하세요.
            </p>
          </div>
          ...
          {showFeedback && (
            ...
            >
              ...
              {!isCorrect && (
                <div className="mt-2">
                  <p className="text-sm text-gray-600">힌트: if문의 정의를 다시 생각해보세요.</p>
                </div>
              )}
            </div>
          )}
